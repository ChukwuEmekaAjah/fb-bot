/*
	this is the source code for my facebook bot. what and what do I need for it
	1. setup the webhooks
	2. link up a post method for requests to the page.
	3. setup my response pattern for any message to the page.
*/
...
function sendTextMessage(recipientId, messageText) {
  var messageData = {
    ...
    message: {
      text: messageText,
      metadata: "this is a cool message and I love it"
    }
  };
